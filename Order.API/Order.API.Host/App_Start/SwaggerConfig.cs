...
namespace Order.API.Host
{
    ...
    {
        /// <summary>
        /// Obtener el path del archivo de documentacion
        /// </summary>
        /// <returns></returns>
        protected static string GetXmlCommentsPath() => Path.Combine(System.Web.HttpRuntime.AppDomainAppPath, "bin", "Order.API.Host.xml");
            ...
            GlobalConfiguration.Configuration
                .EnableSwagger(c =>
                {
                    ...
                    c.ApiKey("Authorization")
                        .Description("Introduce the token JWT here")
                        .Name("Bearer")
                        .In("header");
                    //
                    //c.OAuth2("oauth2")
                ...
                .EnableSwaggerUi(c =>
                {
                    ...
                    //
                    c.DocumentTitle("Challenge ML V1.0");
