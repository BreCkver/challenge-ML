...
namespace Order.API.Business.Contracts.Error
{
    public static class ErrorMessage
    {
        ...
        public const string REQUEST_WRONG = "There are any elements without value assigned or its value is wrong";
        ...
        public const string REQUEST_NOALPHANUMERIC = "The request should have alphanumeric characters only";
    }
}
